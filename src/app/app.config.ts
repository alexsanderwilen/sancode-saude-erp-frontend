...
import { PreloadAllModules, provideRouter, withInMemoryScrolling, withPreloading, RouteReuseStrategy } from '@angular/router';
...
import { ReuseRouteStrategy } from './core/strategies/route-reuse.strategy';
