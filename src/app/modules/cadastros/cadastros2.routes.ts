...
import { BeneficiariosListComponent } from './beneficiarios-list/beneficiarios-list';
import { BeneficiariosFormComponent } from './beneficiarios-form/beneficiarios-form';
...
export const CADASTROS_ROUTES: Routes = [
  {
    ...
    children: [
      ...
      { path: 'beneficiarios', component: BeneficiariosListComponent, title: 'Beneficiários' },
      { path: 'beneficiarios/nova', component: BeneficiariosFormComponent, title: 'Novo Beneficiário' },
      { path: 'beneficiarios/editar/:id', component: BeneficiariosFormComponent, title: 'Editar Beneficiário' },
