...
import { PlanoBaseListComponent } from '../plano-base/plano-base-list/plano-base-list.component';
...
import { AbrangenciaGeograficaListComponent } from '../abrangencia-geografica/abrangencia-geografica-list/abrangencia-geografica-list.component';
import { TipoContratacaoListComponent } from '../tipo-contratacao/tipo-contratacao-list/tipo-contratacao-list.component';
import { PlanoStatusListComponent } from '../plano-status/plano-status-list/plano-status-list.component';
import { TipoPagamentoListComponent } from '../tipo-pagamento/tipo-pagamento-list/tipo-pagamento-list.component';
import { AcomodacaoListComponent } from '../acomodacao/acomodacao-list/acomodacao-list.component';
...
import { TipoPlanoListComponent } from '../tipo-plano/tipo-plano-list/tipo-plano-list.component';
