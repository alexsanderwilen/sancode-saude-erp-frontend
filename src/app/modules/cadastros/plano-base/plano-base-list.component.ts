...
@Component({
  ...
  <ag-grid-angular class="ag-theme-quartz" style="width: 100%; height: 500px;"
                   [gridOptions]="gridOptions" [datasource]="datasource" [columnDefs]="columnDefs">
  </ag-grid-angular>
  `
})
export class PlanoBaseListComponent {
  ...
  constructor(private http: HttpClient, private dialog: MatDialog, private fb: FormBuilder, private operadoraService: OperadoraService, private agGridLocaleService: AgGridLocaleService, private planoBaseService: PlanoBaseService) {
